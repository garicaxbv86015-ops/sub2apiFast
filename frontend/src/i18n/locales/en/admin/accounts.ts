export default {
    accounts: {
      ...
      cnProviders: {
        ...
        windowWeekly: '7d',
        windowMonthly: '30d',
        window7dClaude: '7d Claude',
        window7dFable: '7d Fable',
        window5hTooltip: '5-hour rolling window usage (shared by all models)',
        windowWeeklyTooltip: '7-day rolling window usage (shared by all models)',
        windowMonthlyTooltip: 'Monthly window usage',
        window7dClaudeTooltip: '7-day rolling quota usage for Claude models',
        window7dFableTooltip: '7-day rolling quota usage for Fable models (also counts toward the Claude quota)',
        probe: 'Query',
      ...
      mirasim: {
        apiKeyLabel: 'Mirasim Token / Credential',
        apiKeyPlaceholder: 'ey... (Mirasim JWT Token or relay credential)',
        apiKeyHint: 'Enter your Mirasim login token (JWT) or relay credential. Can be retrieved from ~/.mirasim/setting.json (auth.token) or obtained via auth.',
        deviceId: 'Device ID',
        deviceIdPlaceholder: 'Optional, derived from public key if empty',
        privateKey: 'Device Private Key',
        privateKeyPlaceholder: 'Optional, Ed25519 private key in Hex or Base64',
        deviceHint: 'If device private key and device ID are provided, Sub2API will automatically mint and manage short-term device tickets and signature headers.',
        protocolRules: {
          title: 'Model protocol routing',
          hint: 'In adaptive mode, each model is sent to a native upstream protocol. Use an exact ID or a trailing * glob (e.g. claude-*). The first matching rule wins; unmatched models use Chat Completions.',
          patternPlaceholder: 'claude-* or gpt-6-astra',
          add: 'Add rule',
          remove: 'Remove rule',
          restoreDefaults: 'Restore defaults',
          fallback: 'Unmatched models → Chat Completions (/v1/chat/completions)',
      ...
      types: {
        ...
        mirasimOauth: 'Mirasim OAuth',
        mirasimOauthDesc: 'Browser OAuth, email code, or local app import with auto device identity',
        mirasimManual: 'Manual Credentials',
        mirasimManualDesc: 'Manually enter Token, device private key, and Device ID',
        ...
        antigravity: {
          ...
          authCodePlaceholder:
            'Option 1: Copy the complete URL\n(http://localhost:xxx/auth/callback?code=...)\nOption 2: Copy only the code parameter value',
                  ...
                  // Mirasim specific
                  mirasim: {
                    title: 'Mirasim Authorization',
                    followSteps: 'Follow these steps to complete Mirasim authorization:',
                    ...
                    generateAuthUrl: 'Generate Auth URL',
                    step2OpenUrl: 'Authorize in Browser',
                    openUrlDesc: 'Click the button below to open the Mirasim authorization page in your browser, then log in and approve:',
                    openAuthUrl: 'Open Mirasim Auth Page',
                    step3EnterCode: 'Enter Auth Code or Callback URL',
                    authCodeDesc: 'After authorization, paste the full redirect URL or code parameter below:',
                    authCode: 'Auth Code / Callback URL',
                    authCodePlaceholder: 'Paste full callback URL (http://localhost:port/callback?code=...) or code',
                    authCodeHint: 'Sub2API will automatically exchange tokens and derive Ed25519 device keys & Device ID',
                    importantNotice: 'Note: After authorization, the system will automatically derive device keys and fetch session tickets without manual private key setup',
                    emailCodeAuth: 'Email Verification Code',
                    localAppAuth: 'Import from Local Mirasim.app',
                    emailCodeDesc: 'Enter your Mirasim registered email to receive a verification code and auto-generate device identity:',
                    emailInputLabel: 'Mirasim Email Address',
                    emailPlaceholder: 'Enter your email',
                    sendCode: 'Send Code',
                    resendCode: 'Resend Code',
                    codeInputLabel: 'Verification Code',
                    codePlaceholder: '6-digit code',
                    codeHint: 'Enter the verification code received in your email',
                    verifyAndLogin: 'Verify and Login',
                    verifying: 'Verifying...',
                    localAppTitle: 'One-Click Import from Local Mirasim App',
                    localAppDesc: 'Automatically read logged-in tokens and device keys from ~/.mirasim directory',
                    localAppPathsHint: 'The following configuration files will be read:',
                    importLocalBtn: 'Import Local App Credentials',
                    importing: 'Importing...',
                    refreshTokenAuth: 'Manual RT',
                    refreshTokenDesc: 'Exchange an existing Mirasim Refresh Token and auto-generate device identity:',
                    refreshTokenLabel: 'Mirasim Refresh Token',
                    refreshTokenPlaceholder: 'Enter Mirasim Refresh Token',
                    refreshTokenHint: 'The system will validate the refresh token and derive device keys',
                    validateAndCreate: 'Validate & Create',
                    validating: 'Validating...',
                    pleaseEnterRefreshToken: 'Please enter Refresh Token',
                    failedToValidateRT: 'Failed to validate Refresh Token',
                    failedToGenerateUrl: 'Failed to generate Mirasim auth URL',
                    missingExchangeParams: 'Missing code / session_id / state',
                    failedToExchangeCode: 'Failed to exchange Mirasim auth code',
                    failedToImportLocal: 'Failed to import local Mirasim credentials',
                    failedToSendCode: 'Failed to send verification code',
                    failedToVerifyCode: 'Failed to verify code',
                    devCodeNotice: 'Development mode verification code: {code}',
                    missingEmailOrCode: 'Please enter email and verification code',
      ...
      mirasimAccount: 'Mirasim Account',
