<template>
  <div ref="rootRef" v-if="showUsageWindows">
    ...
    <!-- CN providers (Kimi / Zhipu / DeepSeek / Mirasim): coding-plan quota or payg balance -->
    <template v-else-if="account.platform === 'kimi' || account.platform === 'zhipu' || account.platform === 'deepseek' || account.platform === 'minimax' || account.platform === 'opencode_go' || account.platform === 'mirasim'">
