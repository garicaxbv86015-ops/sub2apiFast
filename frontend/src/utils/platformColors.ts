...
const BADGE: Record<Platform, string> = {
  ...
  mirasim: 'bg-violet-500/10 text-violet-700 border-violet-500/30 dark:text-violet-300',
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  mirasim: 'bg-violet-500/10 text-violet-700 dark:bg-violet-500/10 dark:text-violet-300',
...
const BORDER: Record<Platform, string> = {
  ...
  mirasim: 'border-violet-500/20 dark:border-violet-500/20',
...
const BORDER_STRONG: Record<Platform, string> = {
  ...
  mirasim: 'border-violet-500/35 dark:border-violet-500/30',
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  mirasim: 'bg-gradient-to-r from-violet-400 to-violet-500',
...
const TEXT: Record<Platform, string> = {
  ...
  mirasim: 'text-violet-700 dark:text-violet-300',
...
const ICON: Record<Platform, string> = {
  ...
  mirasim: 'text-violet-500 dark:text-violet-300',
...
const BUTTON: Record<Platform, string> = {
  ...
  mirasim: 'bg-violet-500 text-white hover:bg-violet-600 active:bg-violet-700 dark:bg-violet-500/80 dark:hover:bg-violet-500',
...
const DISCOUNT: Record<Platform, string> = {
  ...
  mirasim: 'bg-violet-100 text-violet-800 dark:bg-violet-900/40 dark:text-violet-300',
...
const GRADIENT: Record<Platform, string> = {
  ...
  mirasim: 'from-violet-500 to-violet-600',
